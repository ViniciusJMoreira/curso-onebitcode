...
type Situation = "Inabitavel" | "Habitavel" | "Habitado" | "Inexplorado";
...
function newPlanet(nome: string, coordenadas: Coordenadas, situacao: Situation) {
  planetas.push({
    nome: nome,
    coordenadas: coordenadas,
    situacao: situacao,
...
function firstMenuOption() {
  ...
  const situacao: Situation = situationPLanet();
