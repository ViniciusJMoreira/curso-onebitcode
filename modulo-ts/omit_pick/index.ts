...
interface GithubRepoResponse {
  ...
  full_name: string
  private: boolean
  // POdemos aplicar em propriedades
...
// Podemos aplicar em tipos
type AccountUser = Pick<GithubUserResponse, 'id' | 'login' | 'name' | 'bio' | 'public_repos' | 'repos_url'>;


// Podemos Aplicar em variaveis
let userName : Pick<GithubRepoResponse, 'name'>;
